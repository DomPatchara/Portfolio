    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20 '>
      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <div className='flex-1'>
          ...
          <h4 className='my-6 text-gray-700 font-Ovo dark:text-white'>Tools & Technologies I Use</h4>

          <ul className='flex items-center gap-3 sm:gap-5' >
            {toolsData.map((tool, i) => (
              <li key={i} className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer
                                      duration-500 hover:-translate-y-1 dark:bg-DarkTheme'>
                <img src={isDarkMode ? tool.darkMode : tool.lightMode} alt="Tool" className='w-5 sm:w-7'/>
              </li>
            ))}
          </ul>
        </div>
